...
export function AdminSidebar() {
  ...
  return (
    <>
      {/* Mobile Top Bar */}
      <div className="md:hidden flex items-center justify-between bg-navy text-white p-4 shadow-md">
        <h1 className="text-xl font-serif text-gold font-bold">OmniCare Admin</h1>
      ...
      {/* Sidebar Content */}
      <div className={`${isOpen ? 'flex' : 'hidden'} md:flex flex-col w-full md:w-64 bg-navy text-white shadow-xl flex-shrink-0 transition-all duration-300`}>
